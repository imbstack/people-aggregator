...
class xHtml {
    ...
    public function html_tag($tag_name, $tag_attr = array(), $is_open = true) {
        ...
        if($is_open) {
            return '<'.strtolower($tag_name).((count($tag_attr) > 0) ? $this->attrsToString($tag_attr) : '').">\n";
        }
        else {
    ...
    public function xhtml_tag($tag_name, $tag_attr = array(), $is_open = true) {
        ...
        return '<'.strtolower($tag_name).((count($tag_attr) > 0) ? $this->attrsToString($tag_attr) : '').(($is_open) ? ">\n" : "/>\n");
    }
    ...
    public function checkbox_tag($name, $tag_attr = array(), $is_checked = false) {
        ...
        return "<input type=\"checkbox\" name=\"$name\" value=\"$is_checked\" ".((count($tag_attr) > 0) ? $this->attrsToString($tag_attr) : '').(($is_checked) ? " checked" : " ")."/>\n";
    }
    ...
    public function radio_butt_tag($name, $tag_attr = array(), $is_checked = false) {
        ...
        return "<input type=\"radio\" name=\"$name\" value=\"$is_checked\" ".((count($tag_attr) > 0) ? $this->attrsToString($tag_attr) : '').(($is_checked) ? " checked" : " ")."/>\n";
    }
    ...
    public function content_tag($tag_name, $content = '', $tag_attr = array(), $escape = true) {
        ...
        return $this->html_tag($tag_name, $tag_attr, true).(($escape) ? htmlspecialchars($content, ENT_COMPAT, $this->encoding) : $content).$this->html_tag($tag_name, array(), false);
    }
    ...
    public function select_tag($sel_options = array(), $tag_attr = array(), $selected = '') {
        ...
        if(count($sel_options) > 0) {
            ...
            foreach($sel_options as $option => $value) {
                $attrs = ($value == $selected) ? array('value' => $value, 'selected' => 'selected') : array('value' => $value,);
