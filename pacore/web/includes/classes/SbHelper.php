...
class SbHelper {
    ...
    function SbHelper() {
        ...
        $field_list = array(
            ...
            // Why FLOAT?  Entry Fee should be OK with strings like ".50" and "400 yen".
            //'1' => array('name' => '/event/price', 'type' => FLOAT, 'caption' => 'Entry Fee'),
            '2' => array(
                'name'    => '/event/location/@postcode',
                'type'    => NUMERIC,
                'caption' => 'Postal code',
            ),
            '3' => array(
                'name'    => 'sb_action_upload_file_name/event/image',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:'.IMAGE_FILE,
            ),
            '4' => array(
        ...
        $this->sb_form_info['event/generic'] = array(
        ...
        $this->sb_form_info['event/concert'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['event/conference'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            ...
            '1' => array(
                'name'    => 'sb_action_upload_file_name/media/@mediaurl',
                'type'    => FILE_VALIDATION,
                'caption' => 'Audio:'.AUDIO_FILE,
            ),
            '2' => array(
                'name'    => 'sb_action_upload_file_name/media/@image',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:'.IMAGE_FILE,
            ),
        );
        $this->sb_form_info['media/audio'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['media/image'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['media/video'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            ...
            '1' => array(
                'name'    => 'sb_action_upload_file_name/review/subject/@coverart',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:image',
            ),
        );
        $this->sb_form_info['review/album'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            '0' => array(
                'name'    => '/review/subject/@title',
                'type'    => EMPTY_STRING,
                'caption' => 'Title of article',
            ),
        );
        $this->sb_form_info['review/article'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            ...
            '1' => array(
                'name'    => 'sb_action_upload_file_name/review/subject/@image',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:image',
            ),
        );
        $this->sb_form_info['review/book'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/club'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            ...
            '1' => array(
                'name'    => 'sb_action_upload_file_name/review/@image',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:image',
            ),
        );
        $this->sb_form_info['review/event'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/hotel'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/localservice'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/magazine'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/movie'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/restaurant'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/software'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/song'] = array(
            'field_list' => $field_list,
        );
        ...
        $this->sb_form_info['review/website'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            ...
            '1' => array(
                'name'    => 'sb_action_upload_file_name/group/image',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:image',
            ),
        );
        $this->sb_form_info['showcase/group'] = array(
            'field_list' => $field_list,
        );
        ...
        $field_list = array(
            '0' => array(
                'name'    => '/showcase/@firstname',
                'type'    => EMPTY_STRING,
                'caption' => 'First name',
            ),
            '1' => array(
                'name'    => 'sb_action_upload_file_name/showcase/image',
                'type'    => FILE_VALIDATION,
                'caption' => 'Image:image',
            ),
        );
        $this->sb_form_info['showcase/person'] = array(
            'field_list' => $field_list,
        );
    }
    ...
    function check_event_date() {
        ...
        elseif(!checkdate($_POST["/event/ends#month"], $_POST["/event/ends#day"], $_POST["/event/ends#year"])) {
    ...
    function get_album_type($sb_mc_type) {
        switch($sb_mc_type) {
            case 'media/image';
