    ...
    public static function buildPagging($nb_items, $page_size, $current_page) {
        ...
        if($total_pages > 0) {
            if($total_pages < 10) {
                ...
                $pagging_last     = (($pagging_first+10) > $total_pages) ? $pagging_first+$pagging_pages_mod-1 : $pagging_first+9;
                ...
                $pagging['next'] = ($pagging_last < ($total_pages-1)) ? ($pagging_last+1) : $pagging_last;
            }
        }
        return $pagging;
    }
