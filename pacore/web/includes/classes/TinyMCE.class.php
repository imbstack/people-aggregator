...
class TinyMCE {
    ...
    public function __construct($type = TinyMCE::full, $mode = 'textareas', $theme = 'advanced', $skin = 'o2k7', $skin_variant = 'silver', $elements = null) {
        $this->type = $type;
    ...
    public function getTinyParam($param_name) {
        return(isset($this->types[$this->type][$param_name])) ? trim($this->types[$this->type][$param_name], " \"'") : null;
    }
