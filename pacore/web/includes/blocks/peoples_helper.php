...
$show_advance_search_options = false;
//flag will be set when used has serached for any of $advance_search_options
            ...
            if($var == 'age') {
                ...
                switch($age_range_count) {
                    case 1:
                        ...
                        $search_data_array['dob']['value'] = array(
                            'lower_limit' => $age_range[0],
                            'upper_limit' => 150,
                        );
