...
<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:fb=\"http://www.facebook.com/2008/fbml\">\n";
    ...
    if($style_css) {
        ...
        if(empty($use_theme)) {
            // TODO: Remove this when new UI is completely independent
...
function getimagehtml($image, $width, $height, $attributes = "", $image_url = "") {
    ...
    // returns actual image attributes
    if($img[1]) {
        $w = $img[0];
        // actual image width
        $h = $img[1];
...
function get_network_search_options() {
    $search_options[] = array(
        'caption' => __('Network name'),
        'value' => 'name',
    );
    $search_options[] = array(
        'caption' => __('Network address'),
        'value' => 'address',
    );
    $search_options[] = array(
        'caption' => __('Network tagline'),
        'value' => 'tagline',
    );
...
function get_groups_search_options() {
    $search_options[] = array(
        'caption' => __('Group name'),
        'value' => 'title',
    );
    $search_options[] = array(
        'caption' => __('Group description'),
        'value' => 'description',
    );
    $search_options[] = array(
        'caption' => __('Group tag'),
        'value' => 'tags',
    );
    return $search_options;
}
...
function get_age_options($field_name, $selected = null) {
    $age_range_options_array = array(
        ''      => __('Select age'),
        '1-10'  => __('Under 10 years'),
        '11-20' => __('11-20 years'),
        '21-30' => __('21-30 years'),
        '31-40' => __('31-40 years'),
        '41-50' => __('41-50 years'),
        '50'    => __('Over 50 years'),
    );
    // ranges can be made configurable by network administrator.
