...
$page = new PageRenderer("setup_module", PAGE_MODULE_SELECTOR, "Module Selector", 'container_two_column.tpl', 'header.tpl', PRI, HOMEPAGE, PA::$network_info);
