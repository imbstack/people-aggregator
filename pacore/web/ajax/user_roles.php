    ...
    <div style="float:left;">
      ...
      <div style="position: relative; float: left; width: auto; margin: 4px;">
        <div id="roles_extra_info">
          <?php foreach($user_roles as $role) { : $curr_role_id = $role['role_id'];
}
$extra = $role['extra']?>
    ...
    <div style="float:left;">
        <div style="position: relative; float: left; padding: 8px;">
          <div class="text">
            <?php if(!$group_id) { :?>
              <?php echo __("Select roles you want to associate with this user and press left/right arrow, <br />"."or click on any of associated roles for managing Role extra data.")?>
            <?php else { :?>
              <?php echo __("Select roles you want to associate with this user and press left/right arrow, <br />"."or click on any of associated roles for more informations about Role permissions.")?>
            <?php endif;
    }
}?>
          </div>
