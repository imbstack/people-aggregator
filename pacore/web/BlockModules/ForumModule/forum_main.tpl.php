      ...
      <tr>
        ...
        <td class="top_navigation">
          <div class="navig_button">
            ...
            <?php if((@$board_settings['allow_users_create_category'] && !($user_status&PaForumsUsers::_anonymous)) || ($user_status&PaForumsUsers::_owner) || ($user_status&PaForumsUsers::_admin)) { :?>
