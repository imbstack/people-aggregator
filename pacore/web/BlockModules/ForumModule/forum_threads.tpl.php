    ...
    <tr>
      ...
      <tr>
        ...
        <td class="top_pagging" colspan="2">
          <?php echo __("Pages: ")?>
          <?php echo $forum->pagination->getPaggingLinks($forums_url."&forum_id=".$forum->get_id(), 'page', 'pagging', 'pagging_selected')?>
        </td>
        <td></td>
      </tr>
      <?php endif;
      ...
      <tr>
        ...
        <td class="top_navigation">
        <?php if(!($user_status&PaForumsUsers::_waiting) && !($user_status&PaForumsUsers::_limited) && !($user_status&PaForumsUsers::_anonymous) && ($user_status&PaForumsUsers::_allowed)) { :?>
