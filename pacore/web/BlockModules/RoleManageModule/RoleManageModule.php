         ...
         <div class="field_big" style="float:left">
          ...
          <div class="center">
            ...
            for($cnt = 0; $cnt < count($role['tasks']); $cnt++) {
                $div_generate .= '<option value="'.$role['tasks'][$cnt]['id'].'" onmouseover="javascript: roles_edit.showdescription(\''.$role['tasks'][$cnt]['description'].'\');"'.'" onmouseout="javascript: roles_edit.showdescription(\''.$info_msg.'\');" >'.$role['tasks'][$cnt]['name'].'</option>';
            }
            $div_generate .= '
                    </select>
                  </div>
