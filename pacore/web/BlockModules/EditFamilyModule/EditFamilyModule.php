    ...
    */
    public function handlePOST($request_data) {
        ...
        if($request_data['addgroup']) {
            ...
            $group_category = 1;
            // diesn't really matter as Familes don't have categories
            $header_image         = NULL;
            ...
            elseif(empty($error_msg)) {
                try {
                    ...
                    $result = Group::save_new_group($collection_id, PA::$login_uid, $groupname, $body, $upfile, $group_tags, $group_category, $access, $reg_type, $is_moderated, $header_image, $header_image_action, $display_header_image, $this->extra);
                    $ccid = $result;
        ...
        $msg_array['success_msg'] = (!empty($this->id)) ? __("Family has been updated successfully.") : __("Family has been created successfully.");
