...
$image_actions[0] = array(
    'caption' => 'Stretch to fit',
    'value' => DESKTOP_IMAGE_ACTION_STRETCH,
);
$image_actions[1] = array(
    'caption' => 'Crop',
    'value' => DESKTOP_IMAGE_ACTION_CROP,
);
$image_actions[2] = array(
    'caption' => 'Tile',
    'value' => DESKTOP_IMAGE_ACTION_TILE,
);
$image_actions[3] = array(
    'caption' => 'Leave it alone',
    'value' => DESKTOP_IMAGE_ACTION_LEAVE,
);
?>
