...
class CustomizeUIModule extends Module {
    ...
    function initializeModule($request_method, $request_data) {
        ...
        switch($this->settings_type) {
            case 'user':
                ...
                $this->side_modules_condition   = ModulesInfo::USER_MODULES_FILTER." && (".ModulesInfo::LEFT_MODULES_FILTER." || ".ModulesInfo::RIGHT_MODULES_FILTER.")";
            ...
            case 'group':
                ...
                $this->side_modules_condition   = ModulesInfo::GROUP_MODULES_FILTER." && (".ModulesInfo::LEFT_MODULES_FILTER." || ".ModulesInfo::RIGHT_MODULES_FILTER.")";
            ...
            case 'network':
                ...
                $this->side_modules_condition   = ModulesInfo::NETWORK_MODULES_FILTER." && !".ModulesInfo::SYSTEM_MODULES_FILTER." && (".ModulesInfo::LEFT_MODULES_FILTER." || ".ModulesInfo::RIGHT_MODULES_FILTER.")";
                $this->middle_modules_condition = ModulesInfo::NETWORK_MODULES_FILTER." && ".ModulesInfo::MIDDLE_MODULES_FILTER." && !".ModulesInfo::SYSTEM_MODULES_FILTER;
                break;
        }
    ...
    */
    private function setupCustomizeModuleSettings($request_data) {
        ...
        $template_tag_attrs = array(
            'name' => "form_data[page_template]",
        ...
        $side_tag_attrs = array(
            'name' => "add_side_module",
        ...
        $middle_tag_attrs = array(
            'name' => "add_middle_module",
    ...
    */
    private function setupCustomizeDesktopImage($request_data) {
        ...
        $this->inner_HTML = $this->generate_inner_html(array('page_url' => $this->url, 'base_url' => $this->base_url, 'uid' => $this->uid, 'gid' => $this->gid, 'header_image_name' => $header_image, 'option' => $header_image_action, 'image_info' => $image_info, 'type' => 'desktop_image', 'dia' => $display_header_image, 'settings_type' => $this->settings_type));
    }
    ...
    */
    private function setupCustomizeStyle($request_data) {
        ...
        $js_path = PA::$theme_url.'/'quote167"javascript"quote167'/';
    ...
    * @param array $request_data holder for data request from server
    */
    ...
    private function handlePOST_applyDesktopImage($request_data) {
        ...
        switch($this->settings_type) {
            ...
            case 'group':
                $group = &$this->shared_data['group_info'];
                $header_img = array(
                    'display_header_image' => $form_data['desktop_image_display'],
    ...
    */
    ...
    /** !!
    * Set the template for the module (in this case the inner template)
    * @param string $template_fname information for which template to use
    */
