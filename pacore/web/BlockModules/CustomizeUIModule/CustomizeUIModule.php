...
class CustomizeUIModule extends Module {
    ...
    public $base_url;
    private $page_templates = array('one'=>'container_one_column.tpl', 'two'=>'container_two_column.tpl', 'two_r'=>'container_two_column_right.tpl', 'three'=>'container_three_column.tpl', 'two_l'=>'container_two_column_left.tpl');
    ...
    */
    private function handlePOST_applyTheme($request_data) {
        ...
        switch($this->settings_type) {
            case 'user':
                $user = &$this->shared_data['user_info'];
                $user_skin = array('theme'=>array('name'=>'theme', 'value'=>$form_data['theme'], 'perm'=>ANYONE));
