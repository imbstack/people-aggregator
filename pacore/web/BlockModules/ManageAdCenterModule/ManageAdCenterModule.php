...
class ManageAdCenterModule extends Module {
    ...
    function initializeModule($request_method, $request_data) {
        ...
        if((!empty($request_data['action'])) && $request_data['action'] == 'edit' && !empty($request_data['ad_id'])) {
            $edit = TRUE;
            $res = Advertisement::get($params = NULL, $condition = array(
                'ad_id' => ((int) $request_data['ad_id']),
            ));
            if(!empty($res)) {
        ...
        elseif((!empty($request_data['action'])) && $request_data['action'] == 'delete' && !empty($request_data['ad_id'])) {
        ...
        elseif(!empty($request_data['action']) && !empty($request_data['ad_id'])) {
            $update = false;
    ...
    */
    function get_ad_options($type, $selected = '') {
        $x_options = array(
            0 => array(
                'caption' => __('Select horizontal position'),
                'value' => 0,
            ),
            1 => array(
                'caption' => '1 - '.__('left').'',
        ...
        $y_options = array(
            0 => array(
                'caption' => __('Select vertical position'),
                'value' => 0,
            ),
            1 => array(
                'caption' => '1 - '.__('top').'',
