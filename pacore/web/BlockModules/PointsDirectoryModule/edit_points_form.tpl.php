 ...
 <fieldset class="center_box">
    ...
    <div class="field">
      ...
      <?php if(count($categories) > 0) { :?>
        <?=xHtml::selectTag(array_combine(array_values($categories), array_values($categories)), array('name' => 'form_data[category]', 'id' => 'form_data_category'), (!empty($item['category'])) ? $item['category'] : null)?>&nbsp;
    ...
    <div class="field">
      ...
      <?=xHtml::selectTag(array_combine(array_values($rating_points), array_values($rating_points)), array('name' => 'form_data[rating]', 'id' => 'form_data_rating'), (!empty($item['rating'])) ? $item['rating'] : null)?>
    </div>
