...
$user = get_user();
// User object for uid specified on query string, or logged in user if no user specified
...
elseif(@$_GET['view_type'] == 'in_relations' && !empty($user)) {
