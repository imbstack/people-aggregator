...
$msg = null;
$message = array();
//array of messages and will be used to display messages.
$showcased_networks = 3;
//number of showcased networks.
...
if(!empty($_POST)) {
    if($section == 'showcased_networks') {
        for($counter = 0; $counter < $showcased_networks; $counter++) {
            ...
            elseif(!empty($_POST['current_network_image'][$counter])) {
    ...
    elseif($section == 'network_of_moment') {
    ...
    elseif($section == 'server_announcement') {
    ...
    if($section == 'video_tours' || $section == 'register_today' || $section == 'network_of_moment' || $section == 'server_announcement') {
        ...
        elseif(!empty($_POST['current_network_image'])) {
            //getting the previously added image from the hidden form field.
