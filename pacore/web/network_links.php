...
elseif(@$_POST['form_action'] == "delete_links" && count($_POST['link_id']) > 0) {
...
elseif(@$_POST['form_action'] == "delete_category" && !empty($_POST['link_categories'])) {
    $param_array = array(
        'user_id'     => $_SESSION['user']['id'],
