<table width="675" border="0" align="center" cellpadding="8">
  ...
  <tr>
    <td colspan="2"><div style=" width: auto; margin: 0px 0px 5px 0px; border-top:#FF9900 1px dashed"></div><center>
      <font face="Arial, Helvetica, sans-serif" size="1" color="#4d748d">PeopleAggregator
        is an open social network service by Broadband Mechanics Inc. &copy;2010</FONT><br>
      <font face="Arial, Helvetica, sans-serif" size="1" color="#89b7cd"><a href="http://broadbandmechanics.com/who.html" style="color:#4d748d;">About
          us</a> | <a href="<?php echo PA::$url;?>/features.php" style="color:#4d748d;">Features</a> | <a href="<?php echo PA::$url;?>/faq.php" style="color:#4d748d;">FAQ</a></font>
          <br>
          <br>
