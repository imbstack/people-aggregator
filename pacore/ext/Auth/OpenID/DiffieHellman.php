...
class Auth_OpenID_DiffieHellman {
    ...
    function getAssocArgs() {
        ...
        if($this->lib->cmp($this->mod, $_Auth_OpenID_DEFAULT_MOD) || $this->lib->cmp($this->gen, $_Auth_OpenID_DEFAULT_GEN)) {
    ...
    function usingDefaultValues() {
        ...
        return($this->mod == $_Auth_OpenID_DEFAULT_MOD && $this->gen == $_Auth_OpenID_DEFAULT_GEN);
    }
