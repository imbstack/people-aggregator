...
class Auth_OpenID_SQLiteStore extends Auth_OpenID_SQLStore {
    ...
    function setSQL() {
        ...
        $this->sql['settings_table'] = "CREATE TABLE %s (setting VARCHAR(128) UNIQUE PRIMARY KEY, "."value BLOB(20))";
        ...
        $this->sql['add_nonce']      = "INSERT OR REPLACE INTO %s (nonce, expires) VALUES (?, ?)";
