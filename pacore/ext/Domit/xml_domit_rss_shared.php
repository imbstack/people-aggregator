    ...
    */
    function &getElement($elementName) {
        ...
        if(isset($this->DOMIT_RSS_indexer[$elementName])) {
            ...
            xml_domit_rss_exception::raiseException(DOMIT_RSS_ELEMENT_NOT_FOUND_ERR, 'Element '.$elementName.' not present.');
        }
    }
    //getElement
    /**
    ...
    */
    function &getElementAt($index) {
        ...
        if(isset($this->DOMIT_RSS_numericalIndexer[$index])) {
            ...
            xml_domit_rss_exception::raiseException(DOMIT_RSS_ELEMENT_NOT_FOUND_ERR, 'Element '.$index.' not present.');
        }
    }
    //getElementAt
    /**
