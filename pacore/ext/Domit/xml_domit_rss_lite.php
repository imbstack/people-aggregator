      ...
      switch ($tagName) {
        ...
        case DOMIT_RSS_ELEMENT_CHANNEL:
          ...
          break;
                ...
                case DOMIT_RSS_ELEMENT_PUB_DATE:
...
class xml_domit_rss_channel_lite extends xml_domit_rss_elementindexer {
  ...
  */
  ...
  //getLastBuildDate function added by <gurpreet.singh@tekritisoftware.com>
  /**
  * Returns the pubDate of the item
  * @return string The pubDate of the item, or an empty string
  */
  function getPubDate() {
    return $this->getElementText(DOMIT_RSS_ELEMENT_PUB_DATE);
  } //getLastBuildDate  
} //xml_domit_rss_channel_lite
...
class xml_domit_rss_item_lite extends xml_domit_rss_elementindexer {
  ...
  */
  ...
  //last build date of the element
  function getPubDate() {
    return $this->getElementText(DOMIT_RSS_ELEMENT_PUB_DATE);
  }
} //xml_domit_rss_item_lite
