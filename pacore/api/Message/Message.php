...
class Message {
    ...
    */
    ...
    function get_conversation_id($message_id) {
        ...
        if($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
            ...
            // for all messages that predate the conversation code
        }
        else {
            return false;
        ...
        while($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
            ...
            if(isset($sende_names[(int) $row->sender_id])) {
                ...
                try {
                    ...
                    $sender_name = $sende_names[(int) $row->sender_id] = $u->login_name;
                }
                catch(PAException$e) {
                    $sender_exists = FALSE;
                }
            ...
            if($sender_exists) {
                // only add this message to display if the sender exists
                $messages[$mid] = $row;
    ...
    */
    ...
    function add_message($sender_id, $recipients_ids = NULL, $all_recipients, $subject, $body, $is_draft = FALSE, $in_reply_to = 0) {
    ...
    */
    ...
    function load_folder_for_user($user_id, $folder_name = INBOX, $cnt = false, $page_no = 1, $msg_per_page = 'ALL', $sortby = 'sent_time', $sort_flag = 0) {
    ...
    */
    ...
    function load_message($folder_id, $message_id, $user_id = null) {
    ...
    */
    ...
    function create_folder($user_id, $folder_name, $flag = 0) {
    ...
    */
    ...
    function get_user_folders($user_id, $show_all = FALSE) {
    ...
    */
    ...
    function move_message_to_folder($index_ids, $new_folder_id, $message_id = null) {
    ...
    */
    ...
    function create_basic_folders($user_id) {
    ...
    */
    ...
    function search_mail($user_id, $search_string, $page_no, $msg_per_page, $sortby, $flag) {
    ...
    */
    ...
    function get_folder_by_name($user_id, $folder_name) {
    ...
    */
    ...
    function edit_message_to_draft($sender_id, $all_recipients, $subject, $body, $message_id) {
    ...
    */
    ...
    function get_new_msg_count($user_id) {
    ...
    */
    ...
    private static function validate_sortby($sortby) {
        ...
        return "NULL";
        // Note: not NULL, "NULL", as this will be included directly into an SQL string!
    }
}
?>
