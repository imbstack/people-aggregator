...
abstract class Content {
    ...
    */
    ...
    public static function _replace_percent_strings($cid, $body, $url) {
        ...
        return str_replace(array("%BASE_URL%", "%PERMALINK%"), array($url, $content_url), $body);
    }
    ...
    function count_trackbacks_for_content($content_id) {
    ...
    function get_trackbacks_for_content($content_id) {
    ...
    public static function load_content_id_array($user_id = 0, $type = NULL, $cnt = FALSE, $show = 'ALL', $page = 0, $sort_by = 'created', $direction = 'DESC', $only_homepage = true) {
        ...
        switch($type) {
            case VIDEO:
                $sb_pattern = 'media/video%';
                break;
            case AUDIO:
                $sb_pattern = 'media/audio%';
                break;
            case IMAGE:
                $sb_pattern = 'media/image%';
                break;
            default:
                $sb_pattern = NULL;
                break;
        ...
        foreach($content_id as &$_content) {
            if(!Content::check_content_privacy($_content)) {
    ...
    */
    ...
    function search_content($search_string_array) {
    ...
    */
    ...
    function content_search($search_string_array, $cnt = FALSE, $show = 'ALL', $page = 0, $sort_by = 'created', $direction = 'DESC') {
        ...
        if(!empty($search_string_array)) {
            // if search string is supplied
    ...
    */
    ...
    function update_content_status($content_id, $is_active = 0) {
    ...
    */
    ...
    public static function load_all_content_id_array($cnt = FALSE, $show = 'ALL', $page = 0, $sort_by = 'created', $direction = 'DESC', $condition = NULL) {
        ...
        elseif(empty($condition['keyword']) && !empty($condition['month'])) {
    ...
    function get_recent_content_for_user($uid, $content_type, $limit) {
        $tables = array(
            IMAGE => "images",
            AUDIO => "audios",
            VIDEO => "videos",
    ...
    */
    public static function delete_user_content($user_id) {
        ...
        //TODO: define the string in constants
        Dal::query($sql, $data);
