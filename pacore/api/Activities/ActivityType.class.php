...
class ActivityType
{
  ...
  public function save() {
      ...
      $sql = "INSERT INTO {activity_types} (id, title, description, type, points) " . 
             "VALUES ('".$this->id."', '".$this->title."', '".$this->description."', '".$this->type."', ".$this->points.") " .
             "ON DUPLICATE KEY UPDATE title = '".$this->title .
