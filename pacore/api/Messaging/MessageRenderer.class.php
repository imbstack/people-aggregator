    ...
    */
        ...
        switch($this->message['category']) {
            ...
            case self::outgoing_email:
                if(is_object($this->requester) && (is_a($this->requester, 'Network') || is_a($this->requester, 'Group') || is_a($this->requester, 'User'))) {
                    ...
                    elseif(is_a($this->requester, 'Group')) {
                        $this->group = $this->requester;
                        $requester = $this->getGroupOwner();
                    }
                    elseif(is_a($this->requester, 'User')) {
                        $requester = $this->requester;
                    }
                    $this->addUserData($requester, 'requester');
                    $this->addUserData($this->recipient, 'recipient');
                }
                elseif(is_string($this->requester)) {
                    $this->addUserData($this->requester, 'requester');
                    $this->addUserData($this->recipient, 'recipient');
                }
                else {
    ...
    private function addUserData($user, $prefix) {
        if(!empty($user)) {
            ...
            elseif(is_string($user)) {
                // email address given instead User object
    ...
    public function getMessageSpecificData() {
        ...
        elseif(is_object($this->associated_obj)) {
            ...
            elseif(is_a($this->associated_obj, 'Comment')) {
                $author = new User();
            ...
            elseif(is_a($this->associated_obj, 'Invitation')) {
                $inviter = new User();
            ...
            elseif(is_a($this->associated_obj, 'RelationData')) {
                $requester = new User();
            ...
            elseif(is_a($this->associated_obj, 'ReportAbuse')) {
                $author = new User();
            ...
            elseif(is_a($this->associated_obj, 'Group')) {
