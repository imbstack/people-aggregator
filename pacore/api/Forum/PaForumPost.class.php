...
class PaForumPost {
    ...
    public function save_PaForumPost() {
        ...
        if(!empty($this->id)) {
            ...
            $this->insert_PaForumPost($this->title, $this->content, $this->user_id, $this->parent_id, $this->thread_id, $this->is_active, $this->created_at, $this->updated_at, $this->modified_by);
        }
    }
