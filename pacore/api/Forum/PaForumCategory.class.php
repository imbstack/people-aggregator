...
class PaForumCategory {
    ...
    public function save_PaForumCategory() {
        ...
        if(!empty($this->id)) {
            ...
            $this->insert_PaForumCategory($this->name, $this->board_id, $this->description, $this->is_active, $this->sort_order, $this->created_at, $this->updated_at);
        }
    }
    ...
    public static function insertPaForumCategory($params = array()) {
        ...
        // call dynamic method
        return $instance->insert_PaForumCategory($name, $board_id, $description, $is_active, $sort_order, $created_at, $updated_at);
    }
