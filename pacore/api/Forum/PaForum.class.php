...
class PaForum {
    ...
    public function save_PaForum() {
        ...
        if(!empty($this->id)) {
            ...
            $this->insert_PaForum($this->title, $this->description, $this->is_active, $this->category_id, $this->sort_order, $this->icon, $this->created_at, $this->updated_at);
        }
    }
    ...
    public static function insertPaForum($params = array()) {
        ...
        // call dynamic method
        return $instance->insert_PaForum($title, $description, $is_active, $category_id, $sort_order, $icon, $created_at, $updated_at);
    }
