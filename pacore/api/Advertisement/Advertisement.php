...
class Advertisement {
  ...
  */
  ...
  static function get($params = NULL, $conditions = NULL) {
...
*/
  ...
  public static function get_orientations() {
    $orientation[] = array('caption'=>__('left'), 'value'=>1);
    $orientation[] = array('caption'=>__('right'), 'value'=>2);
    $orientation[] = array('caption'=>__('middle'), 'value'=>3);
    return $orientation;
  }
