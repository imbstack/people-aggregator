...
<body style="background-color: white;">
    ...
    foreach(array('update', 'create') as $action) {
      ...
      $sections = array(
            'core',
        )+array_keys($merger->userSections);
...
function property_matrix($user) {
    $prop_match = // map dix property names to internal PA user fieldnames
    array("dix://sxip.net/namePerson/first" => "basic/first_name", "dix://sxip.net/namePerson/last" => "basic/last_name", "dix://sxip.net/namePerson/friendly" => "basic/login_name", "dix://sxip.net/contact/internet/email" => "basic/email", "dix://sxip.net/media/image/small" => "basic/picture", "dix://sxip.net/internet/web/default" => "general/homepage", // "dix://sxip.net/contact/web/blog" => "general/homepage",
    "dix://sxip.net/contact/web/Flickr" => "general/flickr", "dix://sxip.net/contact/web/Delicious" => "general/delicious", "dix://sxip.net/company/name" => "professional/company", "dix://sxip.net/company/title" => "professional/title", "dix://sxip.net/media/spokenname" => "general/caption");
    return $prop_match;
}
?>