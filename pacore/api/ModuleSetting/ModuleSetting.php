...
class ModuleSetting {
    ...
    */
    ...
    function save_setting($assoc_id, $page_id, $array_of_data, $assoc_type = "user") {
    ...
    */
    ...
    function load_setting($page_id, $assoc_id, $assoc_type = "network", $child_type = null, $only_configurable = false) {
        ...
        elseif(($assoc_type == 'user') || ($assoc_type == 'group')) {
            ...
            elseif(($only_configurable == true) && $dynamic_page->is_configurable) {
                if(!is_null($child_type)) {
                    if(false !== strpos($dynamic_page->page_type, $child_type)) {
                        $settings = $dynamic_page->getPageSettings();
                    }
    ...
    */
    ...
    function load_default_setting($page_id) {
  ...
  */
    ...
    function save_page_setting($page_id, $array_of_data) {
