...
define_once("MAX_POSTS_PER_FEED", 5);
//maximum number of posts allowed per feed.
define_once("FEED_REFRESH_TIME", 900);
//after FEED_REFRESH_TIME seconds feed is ready for lastest data.
...
define_once("AGE_SEARCH", 'dob_search');
//age search has been handled separately using the DATE_ADD mysyl function.
...
define_once("TIME_INTERVAL", 2*24*60*60);
//its number of seconds in two days
/** ---------------------------------------------------------------------------------------
*
...
*
**/
define_once("ADMINISTRATOR_ROLE", 1);
// Network Admin Role
define_once("LOGINUSER_ROLE", 2);
// Default Login User Role
define_once("ANONYMOUS_ROLE", 3);
// Anonymous User Role
define_once("GROUP_ADMIN_ROLE", 4);
// Group Administrator Role
define_once("GROUP_MODERATOR_ROLE", 5);
// Group Moderator Role
define_once("GROUP_MEMBER_ROLE", 6);
// Group Member Role
define_once("AD_MANAGER_ROLE", 7);
// Ad Manager
define_once("GROUP_AD_MANAGER_ROLE", 8);
// Group Ad Manager Role
define_once("CHILD_MEMBER_ROLE", 9);
// Member of family with 'Child' status
/** ---------------------------------------------------------------------------------------
*
*   Tags
*
