...
class Category {
  ...
  */
    ...
    */
    ...
    function get_position($category_id) {
  ...
  */
    ...
    function build_root_list($attached_type = NULL, $type = 'Default') {
    ...
    */
    ...
    function build_children_list($parent_id, $attached_type = NULL) {
  ...
  */
    ...
    function find_parent($category_id) {
        $position        = Category::get_position($category_id);
    ...
    */
    ...
    public function build_all_category_list($position = '', $spacing = '', $category_tree_array = '', $type = 'Default', $exclude = 1) {
