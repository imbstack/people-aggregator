...
class TekMedia {
    ...
    function __construct() {
        $this->access_key = PA::$video_accesskey;
        //Set your accessKey here.
        $this->secret_key = PA::$video_secretkey;
        //Set your secretKey here.
    }
    ...
    public function generate_form_key($gid = NULL) {
        ...
        //Set your accessKey here.
        $params['secretKey'] = $this->secret_key;
        //Set your secretKey here.
        $params['userid'] = $domain_suffix.'_'.PA::$network_info->network_id.'_'.PA::$login_uid;
        //Set your userid here.
    ...
    */
    public function get_video($video_id) {
        ...
        $response = $client->getResponse();
        if(empty($response['response']['videos'])) {
            return;
        }
