...
?>
  <fieldset class="center_box"> 
    <div class="field">
      <h4><label for="multiple_select"><?= __("Info for: ") ?><?php echo $networks_data[$counter]['caption'] ?></label></h4>
      <div class="privacy_selected" id="div_select_gen"></div>
    </div>
    
    <div class="field_medium">
      <h4><label for="slogan"><?= __("Info URL") ?></label></h4>
...
field_value(@$_POST['network_url'][$counter], 'http://'))?>"/>
    ...
    <div class="field_bigger">
      <h4><label for="curr_desk_image"><?= __("Info Image") ?></label></h4>
...
?>
    <div class="button_position">      
      <input type="submit" name="submit" value="<?= __("Set Info Boxes") ?>" />
    </div>
