...
<div class="wrapper">
  ...
  <h3><?= __("Media Gallery Images") ?>:</h3>
    ...
    <?= __("Select an image album(s) from your gallery to include in new user default galleries. (An album in your gallery may contain one or more images.)") ?>
    <br />
  ...
  <fieldset class="center_box">  
   <div class="field_bigger" style="float:left; width:50%; border-right:1px solid silver">
    <div style="float:left;">
     <h4><label><?= __("Load / restore User Account Defaults from local disk") ?></label></h4>
   ...
   <div class="field_bigger" style="float:left; margin-left:12px">
