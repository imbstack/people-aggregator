...
<div id="pl_response" class="invite_container">
    ...
    <form name="outlook_invite_form" id="outlook_invite_form" action="" method="post">
      <input type="hidden" name="ajax_submit" value="submit" />
      <input type="hidden" name="import_type" value="outlook" />
      ...
      <div class="invite_list_button" style="padding-bottom: 4px; margin-bottom:4px;">
         ...
         <input type="submit" name="submit_contacts_outlook" id="submit_contacts_outlook" onclick="javascript:<?= $js_submit ?>" value="Submit"/>
<!--
         <img src="<?= PA::$theme_url ?>/images/bt_submit.gif" class="input_image" name="submit_contacts_outlook" id="submit_contacts_outlook" style="cursor: pointer" alt="Login" titile="Login" onclick="javascript:<?= $js_submit ?>"/>
-->
      </div>
    </form>
   <?php } ?>
