...
define("INCLUDED_PAGE_PHP", 1); // used on occasion to make sure page.php has been included - DO NOT REMOVE THIS LINE!
...
if (!$login_uid) {
	...
	if (!in_array($e->getCode(), array(USER_NOT_FOUND, USER_ALREADY_DELETED))) throw $e;
...
if (SITE_UNDER_MAINTAINENCE==1) {
  header("Location: ". PA::$url ."/maintenance.php");exit;
}
