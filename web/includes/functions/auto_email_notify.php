...
<?php
  ...
  */
  ...
  function auto_email_notification( $activity_type, $params) {
    ...
    $array_of_data = array('to'         => $notification->to,
...
class EmailNotification {
  ...
  public function send($activity_type, $array_of_data) {
    ...
    if(method_exists($this, $method_name)) {
      $this->{$method_name}($array_of_data);
    } else {
  ...
  function some_joins_a_network($array_of_data) {
    ...
    if($destination == NET_NONE) {//if no notification
     return;
    }
...
*/
    ...
    $this->mail_sub_msg_array = array('joinee'=>$joinee_name, //invited user name
...
*/
  ...
  function bulletin_sent($array_of_data) {
    ...
    $this->message = "Hi $this->owner_name,
                ...
                Peeple Aggregator.
                ";
   $this->mail_sub_msg_array = array('subject'=>$this->subject,
  ...
  function relationship_created_with_other_member($array_of_data) {
    ...
    $this->from = $array_of_data['params']['user_id']; //relation establisher id
  ...
  function switch_destination($destination) {
    ...
    if(empty($this->network_owner)) {  // sometime group_owner param passed as recepient in this var - VERY BAD!
      $net_owner = new User(); 
