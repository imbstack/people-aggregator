...
*/  
  } else if (!empty($_POST) && $_POST['form_action'] == 'create_link') {
  ...
  } else if (!empty($_POST) && $_POST['form_action'] == 'remove_list') {
    $Links = new Links();
    $Links->user_id = $_SESSION['user']['id'];
    $Links->category_id = $_POST['category_id'];
...
*/
  } else if (!empty($_POST) && $_POST['form_action'] == 'edit_list') {
  ...
  } else if (!empty($_POST) && $_POST['form_action'] == 'create_list') {
    $json_string = null;
...
*/    
  } else if (!empty($_POST) && $_POST['form_action'] == 'update_links') {
...
*/    
  } else if (!empty($_GET['action']) && $_GET['action'] == 'edit_list_link') {
  ...
  } else if (!empty($_GET['action']) && $_GET['action'] == 'edit_list') {
    $Links = new Links();
