// ===================================================================
// ModalWindow.js
// extracted from edit_profile.js
// ===================================================================
...
function modal_position() {
  ...
  $("#modal_window").css({width:modal_WIDTH+"px",height:modal_HEIGHT+"px",left: (arrayPageScroll[0] + (pagesize[0] - modal_WIDTH)/2)+"px", top: (arrayPageScroll[1] + (pagesize[1]-modal_HEIGHT)/2)+"px" });
}
