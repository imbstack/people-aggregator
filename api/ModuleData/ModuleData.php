...
class ModuleData {
  ...
  * image url etc store in serailze form in data field of  table ModuleData */
  ...
  static function update($data_image, $id_or_modulename) {
     ...
     $data = array($data_image, $time, $id_or_modulename);
     $res = Dal::query($sql, $data);
     Logger::log("Enter: function ModuleData::update()");
     return;
  }
